...
class _Note_PageState extends State<Note_Page> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: CustomAppBar(title: "Ghi chú", actions: [
        PopupMenuButton<int>(
          color: Colors.white,
            ...
            onTap: () async {
              try {
                ...
                if (isLoggedIn != true) {
                  ...
                  // Show a message indicating user needs to be logged in
                } else {
                  Navigator.push(
                      context,
                      CupertinoPageRoute(
                ...
                // Handle any errors during login check
