...
class _Product_PageState extends State<Product_Page> {
  ...
  Widget ListPDUI2(List<Product>? a) { // print(a);
        return Padding(
          padding: const EdgeInsets.all(8.0),
          child: ListView(
              ...
              ExpansionPanelList(
                ...
                children: a!.map<ExpansionPanel>((Product item) {
                  return ExpansionPanel(
                        ...
                        child: SizedBox(
                          ...
                          child: Card(
                            ...
                            child: Row(children: [
                              ...
                              ListTile(
                                title: Text(menhgia(int.parse(item.Cost) ).toString() + "đ" ,
                                  style: TextStyle(
                                    fontSize: 25,
                    ...
                    body: Column(
                      crossAxisAlignment: CrossAxisAlignment.start, // Aligns children at the start (left side)
                      ...
                      children: [
                        Align(
                          ...
                          child: Container(
                             ...
                             Row(
                               mainAxisAlignment: MainAxisAlignment.end, // Aligns children at the end of the row (right side)
